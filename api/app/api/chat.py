...
def chat():
    try:
        ...
        formatted_messages = [
            {
                "role": "system",
                "content": "Eres un asistente llamado ChatVision. Responde a las preguntas de los usuarios sobre Chat con claridad. Puedes generar imágenes en DALL-E 3. También puedes analizar imágenes que el usuario te envía."
            }
        ]
